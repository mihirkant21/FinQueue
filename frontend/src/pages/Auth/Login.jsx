  ...
  return (
    <div className="flex items-center justify-center min-h-[80vh]">
      <div className="glassmorphism w-full max-w-md p-10 rounded-3xl relative overflow-hidden">
        <div className="absolute top-0 right-0 w-32 h-32 bg-primary/20 rounded-full blur-[40px] -mr-10 -mt-10"></div>
        <div className="absolute bottom-0 left-0 w-32 h-32 bg-secondary/20 rounded-full blur-[40px] -ml-10 -mb-10"></div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
          ...
          <button type="submit" className="w-full bg-primary hover:bg-indigo-700 text-white py-3 rounded-xl font-semibold transition-all shadow-md hover:shadow-lg">
            Sign In
          </button>
        </form>
